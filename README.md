...
Members asked to stop any discriminatory and/or harassing behavior are expected to comply immediately.
...
## Meetings
### Weekly lab meetings
The weekly lab meeting will *always* include sharing brief updates on what everyone has worked on in the past week, and will *sometimes* include lab member presentations. Lab meetings will last no longer than 1.5 hours (and will most often be shorter). All full-time lab members are expected to attend the weekly lab meeting. All part-time lab members (including undergraduates) are welcome to attend, but attendance is not required. The lab meeting day & time will be determined at the beginning of each semester based on lab members' availability. 

Stefano expects all full-time lab members to give a presentation during lab meeting at least once per semester; it is up to each individual lab member to decide what they will present about. Potential options for presentations include: leading a discussion about a journal article, presenting on your current project(s), or leading a mini-workshop on a skill/method. Senior thesis students in the lab are expected to present on their thesis project during a lab meeting near the end of second semester. (Undergraduate research assistants that are *not* working on a thesis are encouraged, but not required, to present during a lab meeting as well.) You will be responsible for working with the lab coordinator to schedule a week for you to present during the semester. Lab member presentations will typically occur only during the academic year, and not the summer, unless Stefano indicates otherwise. If any lab members have questions or concerns about presenting, they can talk to Stefano.
